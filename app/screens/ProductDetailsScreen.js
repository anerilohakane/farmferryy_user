    ...
    <SafeAreaView className="flex-1 bg-white">
      ...
      <ScrollView contentContainerStyle={{ paddingBottom: 120 }}>
        ...
        <View className="p-4">
          ...
          <Text className="text-base text-gray-600 mb-6 leading-relaxed">
            {product.description ||
              'This is a high-quality, organic farm product grown naturally by top farmers in your region.'}
          </Text>
        </View>
      </ScrollView>

      {/* Bottom Buttons */}
      <View className="absolute bottom-0 left-0 right-0 bg-white px-4 py-10 border-t border-green-100 flex-row justify-between">
        {/* Add to Cart Button */}
        <TouchableOpacity
          onPress={handleAddToCart}
          className="w-[48%] bg-green-200 py-4 rounded-2xl items-center"
        >
        ...
        <TouchableOpacity
          onPress={handleBuyNow}
          className="w-[48%] bg-green-700 py-4 rounded-2xl items-center"
        >
          <Text className="text-white text-base font-semibold">Buy Now</Text>
        </TouchableOpacity>
      </View>
